        ...
        <div className="header__wrap">
          <div className="collapse">
            <button onClick={handleExpand} className="navbar__collapse">
              {expand ? <i className="bx bx-x fs-40"></i> : <i className="bx bx-list-ul fs-40"></i>}
            </button>
          </div>
          ...
          <div className="navbar">
                ...
                <div className="browse-categories">
                  <div className="male">
                    ...
                    <ul>
                      ...
                      {/* Thêm các thể loại MALELEAD khác vào đây */}
                    </ul>
                  </div>
                  ...
                  <div className="female">
                    ...
                    <ul>
                      ...
                      {/* Thêm các thể loại FEMALELEAD khác vào đây */}
                    </ul>
                  </div>
                </div>
            ...
            <ul className="navbar__list navbar__list--right">
              <li>
                <Link to={user?.roles[0] === 'ADMIN' ? '/admin/dang-truyen' : '/user/dang-truyen'} className="text-with-icon">
              ...
              {user ? (
                ...
                <>
                  <li>
                    <span onClick={handleAuthLogin}>Sign In</span>
                  </li>
                  <li>
                    <span onClick={handleAuthRegister}>Sign Up</span>
                  </li>
                </>
              )}
            </ul>
