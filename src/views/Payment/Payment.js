            ...
            <div className="payment-list">
              {data.map((item) => (
                <div key={item.id} className="payment-item">
                  <div className="paymen-price">{numWithCommas(item.amount)}đ</div>
                  <div className="paymen-item__button" onClick={() => redirectMomo(item.amount)}>
                    Thanh toán với Momo
                  </div>
                  <div className="paymen-item__button" onClick={() => redirectVNPay(item.amount)}>
